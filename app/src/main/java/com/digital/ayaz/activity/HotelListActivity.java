...
import com.digital.ayaz.databinding.HotelListBinding;
...
public class HotelListActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBinding = DataBindingUtil.setContentView(this, R.layout.hotel_list);
        ...
        getPlaceList(Utility.getNearByHotels(this, latitude, longitude));
